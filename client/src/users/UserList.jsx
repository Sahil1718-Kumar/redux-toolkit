...
import { getUserList, deleteUser, toggleUserStatus } from "../redux/thunkApi";
...
const UserList = () => {
  ...
  const { user_list, loading, error } = useSelector((state) => state.user);
    ...
    <div className="container-fluid" id="tableContainer">
      ...
      <div className="card my-4">
        <div className="card-header bg-info d-flex justify-content-between align-items-center p-3">
          <h6 className="text-white mb-0">User</h6>
          <button
